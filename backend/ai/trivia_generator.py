...
class TriviaGenerator:
    ...
    def generate_multiple_questions(
        ...
        for pokemon in selected_pokemon:
            try:
                ...
                print(f"Failed to generate question for {pokemon.get('name', 'Unknown')}: {e}")
                continue
    ...
    def _format_pokemon_data(self, pokemon_data: Dict[Any, Any]) -> str:
        ...
        info = {
            ...
            "moves": pokemon_data.get("moves", [])[:10],  # Limit moves for prompt length
        }
